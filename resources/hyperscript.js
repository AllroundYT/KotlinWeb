(function (e, t) {
    ...
    class a {
        constructor(e) {
            ...
            this.addGrammarElement("commandList", (function (e, t, r) {
                ...
                return {
                    type: "emptyCommandListCommand", op: function (e) {
            ...
            this.addGrammarElement("indirectStatement", (function (e, t, r, n) {
                if (r.matchToken("unless")) {
                    ...
                    var a = {
                        type: "unlessStatementModifier", args: [i], op: function (e, t) {
                            if (t) {
                                return this.next
                            } else {
                                return n
        ...
        commandBoundary(e) {
            if (e.value == "end" || e.value == "then" || e.value == "else" || e.value == "otherwise" || e.value == ")" || this.commandStart(e) || this.featureStart(e) || e.type == "EOF") {
                return true
            }
            return false
        }
        ...
        ensureTerminated(e) {
            ...
            var r = {
                type: "implicitReturn", op: function (e) {
    ...
    class o {
        ...
        parse(e) {
            const t = this.lexer, r = this.parser;
            var n = t.tokenize(e);
            ...
            if (!n.initialized) {
                ...
                if (i) {
                    try {
                        n.initialized = true;
                        n.script = i;
                        const r = this.lexer, s = this.parser;
                        var a = r.tokenize(i);
    ...
    class f {
        constructor(t, r, n, i, a) {
            this.meta = {parser: a.parser, lexer: a.lexer, runtime: a, owner: t, feature: r, iterators: {}, ctx: this};
    ...
    function T(t) {
        ...
        t.addLeafExpression("string", (function (e, t, r) {
            ...
            return {
                type: "string", token: i, args: o, op: function (e) {
                    var t = "";
        ...
        t.addGrammarElement("nakedString", (function (e, t, r) {
            if (r.hasMore()) {
                ...
                return {
                    type: "nakedString", tokens: n, evaluate: function (e) {
        ...
        t.addLeafExpression("number", (function (e, t, r) {
            ...
            return {
                type: "number", value: a, numberToken: i, evaluate: function () {
                    return a
                }
            }
        }));
        t.addLeafExpression("idRef", (function (e, t, r) {
            ...
            if (i.template) {
                ...
                return {
                    type: "idRefTemplate", args: [s], op: function (e, r) {
                ...
                return {
                    type: "idRef", css: i.value, value: e, evaluate: function (r) {
        ...
        t.addLeafExpression("classRef", (function (e, t, r) {
            ...
            if (i.template) {
                ...
                var s = e.requireElement("expression", o);
                return {
                    type: "classRefTemplate", args: [s], op: function (e, t) {
                ...
                const e = i.value;
                return {
                    type: "classRef", css: e, evaluate: function (t) {
        ...
        t.addLeafExpression("queryRef", (function (e, t, i) {
            ...
            return {
                type: "queryRef", css: s, args: c, op: function (e, ...t) {
                    if (u) {
        ...
        t.addLeafExpression("attributeRef", (function (e, t, r) {
            ...
            return {
                type: "attributeRef", name: u, css: o, value: l, op: function (e) {
                    var t = e.you || e.me;
                    if (t) {
        ...
        t.addLeafExpression("styleRef", (function (e, t, r) {
            ...
            if (i.startsWith("computed-")) {
                ...
                return {
                    type: "computedStyleRef", name: i, op: function (e) {
                        var r = e.you || e.me;
                        if (r) {
                ...
                return {
                    type: "styleRef", name: i, op: function (e) {
                        var r = e.you || e.me;
                        if (r) {
        ...
        t.addGrammarElement("objectKey", (function (e, t, r) {
            ...
            if (n = r.matchTokenType("STRING")) {
                return {
                    type: "objectKey", key: n.value, evaluate: function () {
                        return n.value
                    }
                }
                ...
                r.requireOpToken("]");
                return {
                    type: "objectKey", expr: i, args: [i], op: function (e, t) {
                        return t
                    }, evaluate: function (e) {
                        return t.unifiedEval(this, e)
                    }
        ...
        t.addLeafExpression("objectLiteral", (function (e, t, r) {
            ...
            return {
                type: "objectLiteral", args: [n, i], op: function (e, t, r) {
                    var n = {};
        ...
        t.addGrammarElement("nakedNamedArgumentList", (function (e, t, r) {
            ...
            return {
                type: "namedArgumentList", fields: n, args: [i], op: function (e, t) {
        ...
        t.addGrammarElement("symbol", (function (e, t, r) {
            ...
            if (a && a.value) {
                ...
                return {
                    type: "symbol", token: a, scope: n, name: o, evaluate: function (e) {
        ...
        t.addGrammarElement("implicitMeTarget", (function (e, t, r) {
            return {
                type: "implicitMeTarget", evaluate: function (e) {
                    return e.you || e.me
                }
            }
        }));
        t.addLeafExpression("boolean", (function (e, t, r) {
            ...
            return {
                type: "boolean", evaluate: function (e) {
                    return i
                }
            }
        }));
        ...
        t.addLeafExpression("arrayLiteral", (function (e, t, r) {
            ...
            return {
                type: "arrayLiteral", values: n, args: [n], op: function (e, t) {
                    return t
                }, evaluate: function (e) {
                    return t.unifiedEval(this, e)
                }
        ...
        t.addLeafExpression("blockLiteral", (function (e, t, r) {
            ...
            return {
                type: "blockLiteral", args: n, expr: a, evaluate: function (e) {
                    var t = function () {
        ...
        t.addIndirectExpression("propertyAccess", (function (e, t, r, n) {
            ...
            var a = {
                type: "propertyAccess", root: n, prop: i, args: [n], op: function (e, r) {
        ...
        t.addIndirectExpression("possessive", (function (e, t, r, n) {
            ...
            if (i || n.type === "symbol" && (n.name === "my" || n.name === "its" || n.name === "your") && (r.currentToken().type === "IDENTIFIER" || r.currentToken().type === "ATTRIBUTE_REF" || r.currentToken().type === "STYLE_REF")) {
                if (i) {
                    r.requireToken("s")
                }
                var a, o, s;
                ...
                var u = {
                    type: "possessive", root: n, attribute: a || o, prop: s, args: [n], op: function (e, r) {
                        if (a) {
        ...
        t.addIndirectExpression("inExpression", (function (e, t, r, n) {
            ...
            var i = e.requireElement("unaryExpression", r);
            var a = {
                type: "inExpression", root: n, args: [n, i], op: function (e, r, n) {
                    var i = [];
                    if (r.css) {
        ...
        t.addIndirectExpression("asExpression", (function (e, t, r, n) {
            ...
            var a = {
                type: "asExpression", root: n, args: [n], op: function (e, r) {
        ...
        t.addIndirectExpression("functionCall", (function (e, t, r, n) {
            ...
            if (n.root) {
                var a = {
                    type: "functionCall", root: n, argExressions: i, args: [n.root, i], op: function (e, r, i) {
                ...
                var a = {
                    type: "functionCall", root: n, argExressions: i, args: [n, i], op: function (e, r, i) {
                        t.nullCheck(r, n);
                        if (r.hyperfunc) {
                            i.push(e)
                        }
        ...
        t.addIndirectExpression("attributeRefAccess", (function (e, t, r, n) {
            ...
            if (!i) return;
            var a = {
                type: "attributeRefAccess", root: n, attribute: i, args: [n], op: function (e, r) {
        ...
        var a = ["em", "ex", "cap", "ch", "ic", "rem", "lh", "rlh", "vw", "vh", "vi", "vb", "vmin", "vmax", "cm", "mm", "Q", "pc", "pt", "px"];
        t.addGrammarElement("postfixExpression", (function (e, t, r) {
            ...
            if (i) {
                return {
                    type: "stringPostfix", postfix: i.value, args: [n], op: function (e, t) {
                        return "" + t + i.value
                    }, evaluate: function (e) {
                        return t.unifiedEval(this, e)
                    }
            ...
            if (o) {
                return {
                    type: "timeExpression", time: n, factor: o, args: [n], op: function (e, t) {
                        return t * o
                    }, evaluate: function (e) {
                        return t.unifiedEval(this, e)
                    }
            ...
            if (r.matchOpToken(":")) {
                ...
                return {
                    type: "typeCheck", typeName: s, nullOk: u, args: [n], op: function (e, r) {
        ...
        t.addGrammarElement("logicalNot", (function (e, t, r) {
            ...
            return {
                type: "logicalNot", root: n, args: [n], op: function (e, t) {
                    return !t
                }, evaluate: function (e) {
                    return t.unifiedEval(this, e)
                }
        ...
        t.addGrammarElement("noExpression", (function (e, t, r) {
            ...
            var n = e.requireElement("unaryExpression", r);
            return {
                type: "noExpression", root: n, args: [n], op: function (e, r) {
                    return t.isEmpty(r)
                }, evaluate: function (e) {
                    return t.unifiedEval(this, e)
                }
        ...
        t.addGrammarElement("negativeNumber", (function (e, t, r) {
            ...
            var n = e.requireElement("unaryExpression", r);
            return {
                type: "negativeNumber", root: n, args: [n], op: function (e, t) {
                    return -1 * t
                }, evaluate: function (e) {
                    return t.unifiedEval(this, e)
                }
        ...
        t.addGrammarElement("positionalExpression", (function (e, t, r) {
            ...
            const a = n.value;
            return {
                type: "positionalExpression", rhs: i, operator: n.value, args: [i], op: function (e, t) {
        ...
        t.addGrammarElement("mathOperator", (function (e, t, r) {
            ...
            while (i) {
                ...
                n = {
                    type: "mathOperator", lhs: n, rhs: s, operator: o, args: [n, s], op: function (e, t, r) {
                        if (o === "+") {
                            return t + r
                        } else if (o === "-") {
                            return t - r
        ...
        t.addGrammarElement("logicalOperator", (function (e, t, r) {
            ...
            while (i) {
                ...
                const s = i.value;
                n = {
                    type: "logicalOperator", operator: s, lhs: n, rhs: o, args: [n, o], op: function (e, t, r) {
                        if (s === "and") {
                            return t && r
                        } else {
                            return t || r
        ...
        t.addGrammarElement("asyncExpression", (function (e, t, r) {
            if (r.matchToken("async")) {
                ...
                var i = {
                    type: "asyncExpression", value: n, evaluate: function (e) {
        ...
        t.addGrammarElement("assignableExpression", (function (e, t, r) {
            r.matchToken("the");
            var n = e.parseElement("primaryExpression", r);
            if (n && (n.type === "symbol" || n.type === "ofExpression" || n.type === "propertyAccess" || n.type === "attributeRefAccess" || n.type === "attributeRef" || n.type === "styleRef" || n.type === "arrayIndex" || n.type === "possessive")) {
                return n
            } else {
                e.raiseParseError(r, "A target expression must be writable.  The expression type '" + (n && n.type) + "' is not.")
            }
            return n
        }));
        t.addGrammarElement("hyperscript", (function (e, t, r) {
            ...
            return {
                type: "hyperscript", features: n, apply: function (e, t, r) {
                    for (const i of n) {
                        i.install(e, t, r)
                    }
                }
        ...
        t.addFeature("def", (function (e, t, r) {
            ...
            var m = {
                displayName: o + "(" + s.map((function (e) {
                    return e.value
                })).join(", ") + ")",
                name: o,
                args: s,
        ...
        t.addFeature("worker", (function (e, t, r) {
            if (r.matchToken("worker")) {
                e.raiseParseError(r, "In order to use the 'worker' feature, include " + "the _hyperscript worker plugin. See " + "https://hyperscript.org/features/worker/ for " + "more info.");
                return undefined
            }
        }));
        ...
        t.addFeature("install", (function (t, r, n) {
            ...
            return s = {
                install: function (t, n) {
                    r.unifiedEval({
                        args: [o], op: function (r, o) {
                            var s = e;
                            for (var u = 0; u < a.length; u++) {
                                s = s[a[u]];
                                if (typeof s !== "object" && typeof s !== "function") throw new Error("No such behavior defined as " + i)
                            }
        ...
        t.addFeature("js", (function (t, r, n) {
            ...
            var a = i.jsSource + "\nreturn { " + i.exposedFunctionNames.map((function (e) {
                return e + ":" + e
            })).join(",") + " } ";
            var o = new Function(a);
            return {
                jsSource: a, function: o, exposedFunctionNames: i.exposedFunctionNames, install: function () {
                    Object.assign(e, o())
                }
            }
        }));
        t.addCommand("js", (function (t, r, n) {
            ...
            var u = {
                jsSource: o.jsSource, function: s, inputs: i, op: function (t) {
                    var n = [];
        ...
        t.addCommand("tell", (function (e, t, r) {
            ...
            var o = "tell_" + n.start;
            var s = {
                value: i, body: a, args: [i], resolveNext: function (e) {
        ...
        t.addCommand("wait", (function (e, t, r) {
            ...
            if (r.matchToken("for")) {
                ...
                n = {
                    event: i, on: o, args: [o], op: function (e, r) {
                        var n = r ? r : e.me;
                ...
                n = {
                    type: "waitCmd", time: s, args: [s], op: function (e, r) {
        ...
        t.addGrammarElement("dotOrColonPath", (function (e, t, r) {
            ...
            if (n) {
                ...
                return {
                    type: "dotOrColonPath", path: i, evaluate: function () {
        ...
        function d(e, t, r, n) {
            ...
            var s = {
                eventName: i, details: a, to: o, args: [o, i, a], op: function (e, t, n, i) {
                    r.nullCheck(t, o);
        ...
        var T = function (e, t, r, n) {
            ...
            var a = {
                value: i, args: [i], op: function (e, r) {
        ...
        t.addCommand("halt", (function (e, t, r) {
            if (r.matchToken("halt")) {
                ...
                var o = T(e, t, r, false);
                var s = {
                    keepExecuting: true, bubbling: i, haltDefault: a, exit: o, op: function (e) {
                        if (e.event) {
                            if (i) {
        ...
        t.addCommand("log", (function (e, t, r) {
            ...
            var a = {
                exprs: n, withExpr: i, args: [i, n], op: function (e, r, n) {
                    if (r) {
                        r.apply(null, n)
                    } else {
        ...
        t.addCommand("beep!", (function (e, t, r) {
            ...
            var i = {
                exprs: n, args: [n], op: function (e, r) {
                ...
                o = {
                    op: function (e) {
                        ...
                        while (r = u.exec(n.css)) {
                            if (r[1] === "") i = r[2].trim(); else if (r[1] === "#") o = r[2].trim(); else s.push(r[2].trim())
                        }
        ...
        t.addGrammarElement("pseudoCommand", (function (e, t, r) {
            ...
            if (s) {
                ...
                u = {
                    type: "pseudoCommand", expr: i, args: [i], op: function (e, r) {
                        e.result = r;
                        return t.findNext(u, e)
                    }, execute: function (e) {
                        return t.unifiedExec(this, e)
        ...
        var k = function (e, t, r, n, i) {
            ...
            var m = {
                target: n, symbolWrite: a, value: i, args: [l, c, i], op: function (e, r, i, o) {
                    if (a) {
        ...
        t.addCommand("default", (function (e, t, r) {
            ...
            var a = k(e, t, r, n, i);
            var o = {
                target: n, value: i, setter: a, args: [n], op: function (e, r) {
                    if (r) {
                        return t.findNext(this, e)
                    } else {
                        return a
        ...
        t.addCommand("set", (function (e, t, r) {
            ...
            if (r.currentToken().type === "L_BRACE") {
                ...
                var i = e.requireElement("expression", r);
                var a = {
                    objectLiteral: n, target: i, args: [n, i], op: function (e, r, n) {
                        Object.assign(n, r);
                        return t.findNext(this, e)
                    }
                };
        ...
        t.addCommand("if", (function (e, t, r) {
            ...
            var u = {
                expr: n, trueBranch: i, falseBranch: s, args: [n], op: function (e, r) {
                    if (r) {
                        return i
                    } else if (s) {
                        return s
        ...
        var x = function (e, t, r, n) {
            ...
            e.setParent(v, y);
            var k = {
                name: "repeatInit", args: [s, c, f], op: function (e, t, r, n) {
                    ...
                    if (c) {
                        var a = n || e.me;
                        a.addEventListener(r, (function (t) {
        ...
        t.addCommand("append", (function (e, t, r) {
            ...
            var i = e.requireElement("expression", r);
            var a = {
                type: "symbol", evaluate: function (e) {
            ...
            var s = {
                value: i, target: n, args: [n, i], op: function (e, r, n) {
                    if (Array.isArray(r)) {
                        r.push(n);
                        return t.findNext(this, e)
                    } else if (r instanceof Element) {
        ...
        function g(e, t, r) {
            ...
            if (r.matchToken("inclusive")) n.includeEnd = true; else if (r.matchToken("exclusive")) n.includeStart = false;
            return n
        }
        ...
        class b {
            ...
            next() {
                ...
                if (e === null) return {done: true}; else return {value: e}
            }
        }
        ...
        t.addCommand("increment", (function (e, t, r) {
            ...
            var a = {
                type: "implicitIncrementOp", target: i, args: [i, n], op: function (e, t, r) {
                    t = t ? parseFloat(t) : 0;
                    r = n ? parseFloat(r) : 1;
                    var i = t + r;
                    e.result = i;
        ...
        t.addCommand("decrement", (function (e, t, r) {
            ...
            var a = {
                type: "implicitDecrementOp", target: i, args: [i, n], op: function (e, t, r) {
                    t = t ? parseFloat(t) : 0;
                    r = n ? parseFloat(r) : 1;
                    var i = t - r;
                    e.result = i;
        ...
        t.addCommand("fetch", (function (e, t, r) {
            ...
            var u = {
                url: n, argExpressions: a, args: [n, a], op: function (e, r, n) {
                    var i = n || {};
                    i["sender"] = e.me;
                    i["headers"] = i["headers"] || {};
                    var a = new AbortController;
                    let l = e.me.addEventListener("fetch:abort", (function () {
                        a.abort()
                    }), {once: true});
                    i["signal"] = a.signal;
                    ...
                    return fetch(r, n).then((function (r) {
                        let n = {response: r};
    ...
    function y(e) {
        e.addCommand("settle", (function (e, t, r) {
            if (r.matchToken("settle")) {
                ...
                var i = {
                    type: "settleCmd", args: [n], op: function (e, r) {
                        t.nullCheck(r, n);
                        var a = null;
                        var o = false;
                        var s = false;
                        ...
                        r.addEventListener("transitionstart", (function () {
                            s = true
                        }), {once: true});
                        setTimeout((function () {
                            if (!s && !o) {
        ...
        e.addCommand("add", (function (e, t, r) {
            if (r.matchToken("add")) {
                ...
                if (o) {
                    return {
                        classRefs: o, to: s, args: [s, o], op: function (e, r, n) {
                            t.nullCheck(r, s);
                    ...
                    return {
                        type: "addCmd", attributeRef: i, to: s, args: [s], op: function (e, r, n) {
                            t.nullCheck(r, s);
                            t.implicitLoop(r, (function (r) {
                                if (u) {
                                    e.result = r;
                    ...
                    return {
                        type: "addCmd", cssDeclaration: a, to: s, args: [s, a], op: function (e, r, n) {
                            t.nullCheck(r, s);
                            t.implicitLoop(r, (function (e) {
                                e.style.cssText += n
                            }));
        ...
        e.addGrammarElement("styleLiteral", (function (e, t, r) {
            ...
            return {
                type: "styleLiteral", args: [i], op: function (e, t) {
                    var r = "";
        ...
        e.addCommand("remove", (function (e, t, r) {
            if (r.matchToken("remove")) {
                ...
                if (a) {
                    return {
                        elementExpr: a, from: s, args: [a, s], op: function (e, r, n) {
                            t.nullCheck(r, a);
                            t.implicitLoop(r, (function (e) {
        ...
        e.addCommand("hide", (function (e, t, r) {
            if (r.matchToken("hide")) {
                ...
                var s = i(e, r, o);
                return {
                    target: a, args: [a], op: function (e, r) {
                        t.nullCheck(r, a);
                        t.implicitLoop(r, (function (e) {
                            s("hide", e)
                        }));
        ...
        e.addCommand("show", (function (e, t, r) {
            if (r.matchToken("show")) {
                ...
                var c = i(e, r, o);
                return {
                    target: a, when: l, args: [a], op: function (e, r) {
                        t.nullCheck(r, a);
                        t.implicitLoop(r, (function (r) {
                            if (l) {
                                e.result = r;
        ...
        e.addCommand("take", (function (e, t, r) {
            if (r.matchToken("take")) {
                ...
                if (c) {
                    var s = {
                        classRefs: l, from: a, forElt: o, args: [l, a, o], op: function (e, r, n, i) {
                            t.nullCheck(i, o);
                            t.implicitLoop(r, (function (e) {
                                var r = e.className;
                                if (n) {
                    ...
                    var s = {
                        attributeRef: n, from: a, forElt: o, args: [a, o, i], op: function (e, r, i, s) {
                            t.nullCheck(r, a);
                            t.nullCheck(i, o);
                            t.implicitLoop(r, (function (e) {
                                if (!s) {
        ...
        e.addCommand("put", (function (e, t, r) {
            if (r.matchToken("put")) {
                ...
                var h = {
                    target: o, operation: s, symbolWrite: l, value: n, args: [c, f, n], op: function (e, r, n, i) {
                        if (l) {
                            a(t, e, n, i)
                        } else {
                            t.nullCheck(r, c);
                            if (s === "into") {
                                ...
                                var o = s === "before" ? Element.prototype.before : s === "after" ? Element.prototype.after : s === "start" ? Element.prototype.prepend : s === "end" ? Element.prototype.append : Element.prototype.append;
                                t.implicitLoop(r, (function (e) {
        ...
        function o(e, t, r) {
            var n;
            if (r.matchToken("the") || r.matchToken("element") || r.matchToken("elements") || r.currentToken().type === "CLASS_REF" || r.currentToken().type === "ID_REF" || r.currentToken().op && r.currentToken().value === "<") {
                ...
                n = {
                    type: "pseudopossessiveIts", token: i, name: i.value, evaluate: function (e) {
            ...
            if (n.matchToken("transition")) {
                ...
                while (!e.commandBoundary(l) && l.value !== "over" && l.value !== "using") {
                    if (n.currentToken().type === "STYLE_REF") {
                        ...
                        a.push({
                            type: "styleRefValue", evaluate: function () {
                                return t
                            }
                        })
                    } else {
                    ...
                    if (n.matchToken("initial")) {
                        u.push({
                            type: "initial_literal", evaluate: function () {
                                return "initial"
                            }
                        })
                    } else {
                ...
                var m = {
                    to: u, args: [i, a, s, u, f, c], op: function (e, n, a, o, s, u, l) {
                        t.nullCheck(n, i);
                        var c = [];
                        t.implicitLoop(n, (function (e) {
        ...
        e.addCommand("measure", (function (e, t, r) {
            ...
            var n = o(e, t, r);
            var i = [];
            if (!e.commandBoundary(r.currentToken())) do {
                i.push(r.matchTokenType("IDENTIFIER").value)
            } while (r.matchOpToken(","));
            return {
                properties: i, args: [n], op: function (e, r) {
                    t.nullCheck(r, n);
                    if (0 in r) r = r[0];
                    ...
                    t.forEach(i, (function (t) {
                        if (t in e.result) e.locals[t] = e.result[t]; else throw "No such measurement as " + t
                    }));
                    return t.findNext(this, e)
                }
            }
        ...
        e.addLeafExpression("closestExpr", (function (e, t, r) {
            if (r.matchToken("closest")) {
                ...
                var u = {
                    type: "closestExpr", parentSearch: n, expr: o, css: i, to: s, args: [s], op: function (e, r) {
                        if (r == null) {
                            return null
                        } else {
                            let e = [];
        ...
        e.addCommand("go", (function (e, t, r) {
            if (r.matchToken("go")) {
                ...
                var p = {
                    target: i, args: [i, c], op: function (e, r, i) {
                        if (n) {
                            window.history.back()
                        } else if (a) {
                            if (r) {
        ...
        r.conversions["Fragment"] = function (t) {
            ...
            e.runtime.implicitLoop(t, (function (e) {
                if (e instanceof Node) r.append(e); else {
