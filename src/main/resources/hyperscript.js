    ...
    function hyperscriptWebGrammar(parser) {
        ...
        parser.addCommand("transition", function (parser, runtime, tokens) {
            if (tokens.matchToken("transition")) {
                ...
                } else if (tokens.matchToken("usings")) {
                    var usings = parser.requireElement("expression", tokens);
                }

                var transition = {
                    to: to,
                    args: [targetsExpr, properties, from, to, usings, over],
                    op: function (context, targets, properties, from, to, usings, over) {
                        ...
                        runtime.implicitLoop(targets, function (target) {
                            var promise = new Promise(function (resolve, reject) {
                                ...
                                if (over) {
                                    ...
                                    target.style.transition = usings;
                                } else {
